...
# ╔═╡ b21474c8-a2e1-4055-a66b-d9fb9fd32427
using Measurements

# ╔═╡ db07bd8a-73e5-4ecc-a4f7-5cffd58bf79a
using Symbolics
...
# ╔═╡ 88cd18ad-8ad9-4c8a-9f7f-0a303a76b095
x=π/3. ± π/25.0

# ╔═╡ ef058a47-0524-4fdf-9fc0-ae24cac4e52e
tan(x)

# ╔═╡ aa70a181-f15b-4948-adf6-942722603964
@variables x1 y1 z1

# ╔═╡ 2ac9c7f4-4bd2-4f26-a9f4-f8fef2b2a468
Dx=Differential(x1)

# ╔═╡ e54f0f72-bffc-4b04-9a79-cffa599da5d9
simplify(expand_derivatives(Dx(tan(x1))))

# ╔═╡ c0479372-7e15-44f7-be12-1d7c5d9aa5b3
sqrt((sec(π/3.0)^2*π/25.0)^2)

# ╔═╡ 0fc1da0b-1d10-45c8-b688-64cb723be1ce
tan(x)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "853e093a2126d0c8229a0c12b8bc95674b74aa39"
